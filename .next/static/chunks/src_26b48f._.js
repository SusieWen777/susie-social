(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_26b48f._.js", {

"[project]/src/components/MobileMenu.tsx [app-client] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, k: __turbopack_refresh__ }) => (() => {
"use strict";
...
function MobileMenu() {
    ...
    if ($[0] !== "1001e2e7f079fe259dd2e4f37c811fc24dab4aa0ac7acaf888a4204d7a225f30") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "1001e2e7f079fe259dd2e4f37c811fc24dab4aa0ac7acaf888a4204d7a225f30";
    }
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = ()=>setIsOpen((prev)=>!prev);
        $[1] = t0;
    } else {
        t0 = $[1];
    }
    const t1 = `w-6 h-1 bg-blue-500 rounded-sm ${isOpen ? "rotate-45" : ""} origin-left ease-in-out duration-500`;
    let t2;
    if ($[2] !== t1) {
    ...
    const t3 = `w-6 h-1 bg-blue-500 rounded-sm ${isOpen ? "opacity-0" : ""}`;
    let t4;
    if ($[4] !== t3) {
    ...
    const t5 = `w-6 h-1 bg-blue-500 rounded-sm ${isOpen ? "-rotate-45" : ""} origin-left ease-in-out duration-500`;
    let t6;
    if ($[6] !== t5) {
    ...
    let t8;
    if ($[12] !== isOpen) {
        t8 = isOpen && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$experimental$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: "/",
                    children: "Home"
                }, void 0, false, {
                    fileName: "[project]/src/components/MobileMenu.tsx",
...
//# sourceMappingURL=src_26b48f._.js.map